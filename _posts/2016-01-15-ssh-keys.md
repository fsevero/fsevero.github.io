...
Tutorial retirado do [GitHub](https://help.github.com/articles/generating-ssh-keys/) sobre como gerar e disponibilizar suas chaves SSH no ubuntu e suas variações.
